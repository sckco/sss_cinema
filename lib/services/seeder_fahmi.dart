...
class SeederFilmFahmi {
  ...
  Future<void> seedMoviesFahmi() async {
    try {
      ...
      final snapshot = await _db.collection(FirestoreCollectionsFahmi.moviesFahmi).get();
      print('Found ${snapshot.docs.length} existing movies');
      ...
      for (var movie in movies) {
        print('Seeding movie: ${movie.title}');
